package co.codingnomads.kraken.model.account.response.pojo;
...
public class KrakenAccountBalance {
    ...
    public KrakenAccountBalance(@JsonProperty("ZEUR") String ZEUR,
